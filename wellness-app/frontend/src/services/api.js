...
export const aiApi = {
  ...
  coach: () => api.post('/ai/coach'),
  analyzeJournal: (text) => api.post('/ai/analyze-journal', { journal_text: text }),
  speechToText: (formData) => api.post('/ai/speech-to-text', formData),
  smartRecommendations: (context) => api.post('/ai/smart-recommendations', { user_context: context }),
}
